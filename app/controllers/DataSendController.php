		...
		if (isset($_GET["equi"]) /*&& isset($_POST['loc']) && isset($_POST['iden']) && isset($_POST['dsp']) && isset($_POST['dep'])*/){
			...
			if (!$docRepor -> count()) {
				...
				foreach ($docRepor as  $v) {
					...
					//file_put_contents("/var/www/senditlaravel42/public/photos/".$v['EQUIPMENT']['WORK']['PHOTOS']['PHOTO1'], $photo);
				...
				foreach ($docRepor as $v) {
					...
					$photo = $v['EQUIPMENT']['WORK']['PHOTOS']['PHOTO1'];
					//echo strlen($photo);
					$name_photo = substr($photo,-22);
					echo "nombre de la foto: ".$name_photo;
